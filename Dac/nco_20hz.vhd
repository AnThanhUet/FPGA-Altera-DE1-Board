...
ARCHITECTURE SYN OF nco_20hz IS


	COMPONENT nco_20hz_st
	PORT (
		phi_inc_i	: IN STD_LOGIC_VECTOR (31 DOWNTO 0);
		clk	: IN STD_LOGIC;
		reset_n	: IN STD_LOGIC;
...
-- Retrieval info:  <NETLIST_SECTION active_core="nco_20hz_st" >
...
-- Retrieval info:      <PRIVATE name = "MODULE_NAME" value="nco_20hz_st"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="nco_20hz_st.v"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "RCFC" value="nco_20hz_cos_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVC" value="nco_20hz_cos_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHC" value="nco_20hz_cos_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCFF" value="nco_20hz_cos_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVF" value="nco_20hz_cos_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHF" value="nco_20hz_cos_f.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFC" value="nco_20hz_sin_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVC" value="nco_20hz_sin_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHC" value="nco_20hz_sin_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFF" value="nco_20hz_sin_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVF" value="nco_20hz_sin_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHF" value="nco_20hz_sin_f.hex"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "PHI_INC" value="687"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen_enable">
-- Retrieval info:      <PRIVATE name = "language" value="VHDL"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen">
-- Retrieval info:      <PRIVATE name = "filename" value="nco_20hz.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "greybox">
-- Retrieval info:      <PRIVATE name = "filename" value="nco_20hz_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
