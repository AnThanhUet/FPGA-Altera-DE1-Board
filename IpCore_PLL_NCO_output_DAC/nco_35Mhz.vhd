...
-- 			nco_35Mhz_st
-- ============================================================
-- Generated by NCO 13.0 [Altera, IP Toolbench 1.3.0 Build 156]
-- ************************************************************
...
ARCHITECTURE SYN OF nco_35Mhz IS


	COMPONENT nco_35Mhz_st
	PORT (
		phi_inc_i	: IN STD_LOGIC_VECTOR (31 DOWNTO 0);
		clk	: IN STD_LOGIC;
		reset_n	: IN STD_LOGIC;
...
BEGIN
	...
	nco_35Mhz_st_inst : nco_35Mhz_st
	PORT MAP (
		phi_inc_i  =>  phi_inc_i,
		fsin_o  =>  fsin_o,
		fcos_o  =>  fcos_o,
...
-- Retrieval info: <MEGACORE title="NCO"  version="13.0"  build="156"  iptb_version="1.3.0 Build 156"  format_version="120" >
-- Retrieval info:  <NETLIST_SECTION active_core="nco_35Mhz_st" >
...
-- Retrieval info:      <PRIVATE name = "FSAMP_VALUE" value="125"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "FREQ_VALUE" value="35"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "MODULE_NAME" value="nco_35Mhz_st"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="nco_35Mhz_st.v"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "RCFC" value="nco_35Mhz_cos_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVC" value="nco_35Mhz_cos_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHC" value="nco_35Mhz_cos_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCFF" value="nco_35Mhz_cos_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVF" value="nco_35Mhz_cos_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHF" value="nco_35Mhz_cos_f.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFC" value="nco_35Mhz_sin_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVC" value="nco_35Mhz_sin_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHC" value="nco_35Mhz_sin_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFF" value="nco_35Mhz_sin_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVF" value="nco_35Mhz_sin_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHF" value="nco_35Mhz_sin_f.hex"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "PHI_INC" value="1202590843"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen_enable">
-- Retrieval info:      <PRIVATE name = "language" value="VHDL"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "simgen">
-- Retrieval info:      <PRIVATE name = "filename" value="nco_35Mhz.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "greybox">
-- Retrieval info:      <PRIVATE name = "filename" value="nco_35Mhz_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
