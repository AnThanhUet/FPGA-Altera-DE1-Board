...
set ipfs_ext "vho"
if {[file exists nco_0.vho]} {
	set hdl_ext "vhd"
} else {
	puts "Warning: Could not find nco_0.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME nco_0_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.nco_0_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "nco_0.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "nco_0_tb.${hdl_ext}" -section_id tb -library work
