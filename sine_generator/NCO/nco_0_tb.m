...
% file : nco_0_tb.m
%
% Description : The following Matlab testbench excercises the NCO model nco_0_model.m
...
[sin_out,cos_out] = nco_0_model(phi_inc_i,phase_mod_i,freq_mod_i);
fid_s = fopen('fsin_o_nco_0_matlab.txt','w');
for i=1:N
  fprintf(fid_s,'%f\n',sin_out(i));
end
