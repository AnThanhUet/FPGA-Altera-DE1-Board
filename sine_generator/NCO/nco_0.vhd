...
-- Retrieval info:  <NETLIST_SECTION active_core="nco_0_st" >
...
-- Retrieval info:      <PRIVATE name = "MODULE_NAME" value="nco_0_st"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="nco_0_st.v"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "RCFC" value="nco_0_cos_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVC" value="nco_0_cos_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHC" value="nco_0_cos_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCFF" value="nco_0_cos_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVF" value="nco_0_cos_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHF" value="nco_0_cos_f.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFC" value="nco_0_sin_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVC" value="nco_0_sin_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHC" value="nco_0_sin_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFF" value="nco_0_sin_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVF" value="nco_0_sin_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHF" value="nco_0_sin_f.hex"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="898"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "NUM_DSP_BLOCKS" value="1"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "filename" value="nco_0.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "greybox">
-- Retrieval info:      <PRIVATE name = "filename" value="nco_0_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- =========================================================
-- RELATED_FILES: nco_0_st.v, nco_0.vhd;
-- IPFS_FILES: nco_0.vho;
-- =========================================================
