...
if {[file exist "/home/annt/Workspace/FPGA/Dac/nco_50_hz.mpf"] == 0} {
  project new [pwd] nco_50_hz
} else	{
project open nco_50_hz
}
...
vcom -93 nco_50_hz.vho
vcom -93 nco_50_hz_tb.vhd
vsim -novopt nco_50_hz_tb
do nco_50_hz_wave.do
run 22000 ns
